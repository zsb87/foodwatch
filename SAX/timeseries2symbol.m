...
%
function [symbolic_data, pointers, stddev] =  timeseries2symbol(data, N, n, alphabet_size, NR_opt)
    ...
    for i = 1 : length(data) - (N -1)                                       
        ...
        % Extract the current subsection.
        sub_section = data(i:i + N -1); 

        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % if would like to add judgement before normalization, add here
        %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % Z normalize it.
        stddev = [stddev;std(sub_section)];
