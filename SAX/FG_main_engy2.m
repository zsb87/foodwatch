...
subjs = {'Dzung'}; %'Rawan','JC','Cao','Jiapeng','Eric','Eric',
...
%    if want to save a  different run's result. change to 2:2, 3:3 ....
    ...
    %     num_TP_all = [];
        ...
        [motif_SAX_cell] = FG_motif_sel2(train_sig_cell, train_gt_htcell, config_file, motif_sel_mode);
...
%             end
    ...
    %     result = [result; num_motif_all];
        ...
        resultfile_all = ['engy_run',num2str(run),'_result_',test_subj,'_Msel',int2str(motif_sel_mode),'_thre',num2str(dist_thres),'_meas',num2str(meas_thres),'_3motifs.csv'];
