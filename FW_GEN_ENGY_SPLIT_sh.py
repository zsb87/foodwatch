...
subjs = ['Jiapeng','Matt']#['JC','Jiapeng','Matt','Rawan', 'Cao']#,'Dzung','Will', 'Gleb', 'JC','Matt','Jiapeng', 'Cao', 'Eric'
...
for active_participant_counter, subj in enumerate(subjs):
    ...
    if 1:
        ...
        birthfileT = "../"+protocol+"/subject/"+subjfolder+'/tripod video birth.txt'
        birthfileD = "../"+protocol+"/subject/"+subjfolder+'/desk video birth.txt'
        ...
        if annotation_state == 3:
            ...
            annotDf_D = importAnnoFile("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-desk.csv")
            annotDf_T = importAnnoFile("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-tripod.csv")
            ...
            if save_flg:
                annotDf_D.to_csv("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-deskprocessed.csv")
                annotDf_T.to_csv("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-tripodprocessed.csv")
                annotDf.to_csv("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-united-processed.csv")
            

        if annotation_state ==2:
            birthfile = birthfileD
            annotDf = importAnnoFile("../"+protocol+"/subject/" + subjfolder + "/annotation/annotations-edited-"+position+".csv")
        ...
        r_df_test_label.to_csv("../"+protocol+"/subject/" + subjfolder + "/testdata_labeled.csv")
